...
<terminology><![CDATA[<< /Version 2
                         /Events <<
                         /B82A4402-2148-42EC-80E7-5A3B9C0D2E26 [($$$/nonparel/recordableAPsRETOUCHSelectProject=APsRETOUCH SelectProject) <<
                          >>]
                         ]>>
                      >> ]]>
</terminology>
...
#target photoshop
#script "APsRETOUCH_SelectProject"
#strict on
...
var g_script_name 	= 'APsRETOUCH_SelectProject';
...
/////////// /основное окно /////////////////////
    ...
    if (paramHolder2["id"] === undefined || paramHolder2["id"] === '') 
 			paramHolder2["id"] = 'APsSelPrj' + generateUUID();
